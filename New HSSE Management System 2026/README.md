...
Procedure, Records, Related Documents, Revision History).

## Architecture
| Folder | Contents |
|--------|----------|
| 00-Governance | Manual, scope, document-control & master list |
| 01-Context | Organisational context, interested parties |
| 02-Leadership | Policies, roles & responsibilities |
| 03-Planning | Objectives, legal register, change management |
| 04-Risk-Management | Risk assessment, JHA/AHA, opportunities |
| 05-Support | Competence, training, communication, documented info |
| 06-Operations | Operational controls, PTW, contractor mgmt, DCSM chapters |
| 07-Emergency-Management | Emergency preparedness & response |
| 08-Performance-Evaluation | Monitoring, audit, management review |
| 09-Incident-Management | Incident reporting & investigation |
| 10-Continual-Improvement | Nonconformity, corrective action, improvement |
| Forms / Registers / Templates / Checklists / Work-Instructions / Guidance-Documents | Supporting records |

## Documents issued
| Doc No. | Title | Rev | Folder |
|---------|-------|-----|--------|
